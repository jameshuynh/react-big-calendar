...
var propTypes = {
  ...
  isInsidePopup: _propTypes2.default.bool,
...
var EventCell = function (_React$Component) {
  ...
  EventCell.prototype.render = function render() {
    ...
    var _props = this.props,
        ...
        extraClassAccessor = _props.extraClassAccessor,
        slotStart = _props.slotStart,
        slotEnd = _props.slotEnd,
        Event = _props.eventComponent,
        EventWrapper = _props.eventWrapperComponent,
        props = _objectWithoutProperties(_props, ['className', 'event', 'selected', 'eventPropGetter', 'startAccessor', 'endAccessor', 'titleAccessor', 'extraClassAccessor', 'slotStart', 'slotEnd', 'eventComponent', 'eventWrapperComponent']);
    ...
    var title = (0, _accessors.accessor)(event, titleAccessor),
        ...
        extraClassName = (0, _accessors.accessor)(event, extraClassAccessor),
    ...
    return _react2.default.createElement(
      ...
      _react2.default.createElement(
        'div',
        {
          ...
          className: (0, _classnames2.default)('rbc-event', className, xClassName, extraClassName, {
          ...
          onClick: function onClick(e) {
            return _this2.onSelectEvent(event, e);
          } },
        _react2.default.createElement(
          'div',
          {
  ...
  EventCell.prototype.onSelectEvent = function onSelectEvent(event, e) {
